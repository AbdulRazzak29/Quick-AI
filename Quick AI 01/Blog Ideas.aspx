<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Blog Ideas.aspx.cs" Inherits="Quick_AI_01.Blog_Ideas" %>
...
<body>
                ...
                <div class="col-md-4">
                    <div class="dashboard-box margin-top-0 margin-bottom-30" style="width: 300px;">
                        ...
                        <div class="content with-padding">
                            <div class="notification small-notification notice">Enticing article/blog introductions that capture the attention of the audience.</div>
   ...
   <script>
       $('#export_to_word').on('click', function () {
           $.ajax({
