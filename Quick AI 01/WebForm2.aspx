<%@ Page Title="" Language="C#" MasterPageFile="~/AI.Master" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="Quick_AI_01.WebForm2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <img src="img/home-hero-icon.png" / style=" display: block;
  margin-left: auto;
  margin-right: auto;
  width: 20%;">
    <section>
...
<h1 class="margin-bottom-10 text_gradient_animation">
     ...
     <a action="https://localhost:44308/LoginPage4.aspx" class="btn btn-primary active" aria-current="page">Get Started For Free</a>
