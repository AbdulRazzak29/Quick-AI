    ...
    <div style="margin-top: 10%">
        ...
        <section>
            ...
            <div class="margin-bottom-10 text_gradient_animation" style="text-align: center">
                ...
                <p>
                    Create SEO-optimized and unique content for your blogs, ads, emails,<br />
                        ...
                        <a href="#" title="Not available in the free plan" data-tippy-placement="top">
                            <div class="dashboard-box ai-templates ai-templates-pro">
                                <div class="content">
                                    ...
                                    <h4>Blog Section   <span class="dashboard-status-button yellow"><i class="fa fa-gift"></i>Pro</span></h4>
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="pricing-plan-label" style="height: 60px; width: 175px;">
                                <input type="text" id="input-field" disabled style="height: 30px; background-color: #f0f0f0;">
                            </div>
                        </li>
                        <li>Features of Free Plan</li>
                        <li><b>32</b> AI Document Templates</li>
