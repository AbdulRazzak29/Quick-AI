<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Current Plan.aspx.cs" Inherits="Quick_AI_01.Current_Plan" %>
                                ...
                                <table id="js-table-list" class="basic-table dashboard-box-list">
                                    ...
                                    <tr>
                                        <td align="right" colspan="7">
                                            <button type="button" class="button" onclick="window.location.href='#'" style="margin-top: -53px;">Change Plan</button></td>
                                    </tr>
                                </tbody></table>
                            </div>
                        </div>
