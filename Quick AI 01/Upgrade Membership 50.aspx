<%@ Page Title="" Language="C#" MasterPageFile="~/AI.Master" AutoEventWireup="true" CodeBehind="Upgrade Membership 50.aspx.cs" Inherits="Quick_AI_01.Upgrade_Membership_50" %>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <span class="PaymentMethod-info">50 ₹</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                ...
                <div class="boxed-widget summary margin-top-0" style="    position: inherit;">
                    ...
                    <div class="boxed-widget-inner" >
                        <ul>
                            ...
                            <li>Expiry Date <span>05-2024</span></li>
                            <li class="total-costs">Total Cost <span>50 ₹</span></li>
                        </ul>
                    </div>
                </div>
            </div>
