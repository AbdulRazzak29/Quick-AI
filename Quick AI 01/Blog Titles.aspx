<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Blog Titles.aspx.cs" Inherits="Quick_AI_01.Blog_Titles" %>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="dashboard-box margin-top-0 margin-bottom-30" style="width: 300px;">
                        ...
                        <div class="headline">
                            <h3>
                                <i class="fa fa-ellipsis-h"></i>Blog Titles</h3>
                        </div>
                        <div class="content with-padding">
                            <div class="notification small-notification notice">Nobody wants to read boring blog titles, generate catchy blog titles with this tool.</div>
