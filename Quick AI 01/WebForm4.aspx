<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="Quick_AI_01.WebForm4" %>
...
<body>
    <form id="form1" runat="server">
        <div>
                ...
                <div id="header">
                    <div class="container">
                        ...
                        <div class="left-side">
                            ...
                            <a href="javascript:void(0);" class="header-icon" id="view" >
                                    ...
                                    <div class="header-notifications-trigger">
                                        <a href="#" title="">
                                            <div class="user-avatar status-online">
                                                ...
                                                <img src="img/default_user.png" style="height:58px" />
                                                        </span>
                                            </div>
                                                </div>
                                        </a>
            ...
            <div class="sidebar" style="    margin-top: 61px;" >
                         <ul>
                             <li>
        ...
        <div class="dashboard-content-inner" style="min-height: 411.028px;">
