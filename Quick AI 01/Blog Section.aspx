            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="dashboard-box margin-top-0 margin-bottom-30" style="width: 300px;">
                        ...
                        <div class="headline">
                            <h3>
                                <i class="fa fa-book"></i>Blog Section </h3>
                        ...
                        <div class="content with-padding">
                            <div class="notification small-notification notice">Write a few paragraphs about a subheading of your article.</div>
                            <div class="submit-field margin-bottom-20">
                                ...
                                <h6>Subheadings<span class="form-required">*</span></h6>
                                <textarea name="description" class="with-border quick-text-counter small-input" data-maxlength="400" placeholder="Subheadings 1,Subheadings 2" required=""></textarea><div class="form-text" >0 / 400</div>
                            </div>
                            <div class="submit-field margin-bottom-20">
                                <h6>Language</h6>
