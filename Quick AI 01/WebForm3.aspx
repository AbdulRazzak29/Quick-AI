<%@ Page Title="" Language="C#" MasterPageFile="~/AI.Master" AutoEventWireup="true" CodeBehind="WebForm3.aspx.cs" Inherits="Quick_AI_01.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div>
            <div class="zoom-anim-dialog dialog-with-tabs popup-dialog" id="sign-in-dialog">
                ...
                <div class="popup-tabs-container" >
                    <div class="popup-tab-content" id="login" style="">
                        ...
                        <form id="login-form" method="post">
                            ...
                            <a href="https://localhost:44308/Forgot%20Passward.aspx">Forgot Password?</a>
                            <div>
                                <center>
