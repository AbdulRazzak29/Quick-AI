<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="homepageaspx.aspx.cs" Inherits="Quick_AI_01.homepageaspx" %>
             ...
             <header id="header-container" class="fullwidth dashboard-header sticky" style="position: fixed;">
                ...
                <div id="header">
                    <div class="container">
                        ...
                        <div class="right-side" style="    right: -190px;">
...
<h1 class="text" style="font-size:60px">
            ...
            <p>Create SEO-optimized and unique content for your blogs, ads, emails,<br />and website 10X faster &amp; save hours of work.</p>
    </div>
 </section>
     <br />
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-12">
                    <div class="bg-image">
                      <img src="img/hhh.png" style=" height: 61px;  width: 100px; "  >
                    </div>
                ...
                <div class="col-xl-2 col-lg-2 col-md-4">
                    <div class="footer-links">
                        <h3>My Account</h3>
                        <ul>
                            <li><a href="https://localhost:44308/Login.aspx">Login</a></li>
                            <li><a href="https://localhost:44308/LoginPage4.aspx">Register</a></li>  </ul>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-4">
                    <div class="footer-links">
                ...
                <div class="col-xl-2 col-lg-2 col-md-4">
                    <div class="footer-links">
                        ...
                        <ul>
                            <li><a>FAQ</a></li>
                            <li><a href="https://localhost:44308/Testimonials1.aspx">Testimonials</a></li>                        </ul>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-12">
                    <div class="footer-rows-left">
                        <div class="footer-row">
                            <span class="footer22">2023 Socius IGB Pvt Ltd, All right reserved</span>
                        </div>
                    </div>
